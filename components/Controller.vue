    ...
    <g transform="matrix(1,0,0,1,-50.8086,-83.6438)">
      ...
      <g transform="matrix(0.707107,-0.707107,0.707107,0.707107,-39.0605,310.248)">
        <g id="x" transform="matrix(1.23827,0,0,1.35378,-87.498,-88.0679)">
          <path :class="{ 'active-control': controller?.buttons.x.pressed }"
        ...
        <g id="a" transform="matrix(7.58222e-17,-1.23827,1.35378,8.28952e-17,64.6304,644.745)">
          <path :class="{ 'active-control': controller?.buttons.a.pressed }"
            d="M354.907,196.001C345.094,196.001 337.14,203.277 337.14,212.252L354.907,212.252L354.907,196.001Z"
            style="stroke:currentColor;stroke-width:2.57px;stroke-linecap:round;stroke-miterlimit:1.5;" />
        </g>
        <g id="b" transform="matrix(-1.23827,-1.51644e-16,1.6579e-16,-1.35378,797.443,492.617)">
          <path :class="{ 'active-control': controller?.buttons.b.pressed }"
            d="M354.907,196.001C345.094,196.001 337.14,203.277 337.14,212.252L354.907,212.252L354.907,196.001Z"
            style="stroke:currentColor;stroke-width:2.57px;stroke-linecap:round;stroke-miterlimit:1.5;" />
        </g>
        <g id="y" transform="matrix(-2.27467e-16,1.23827,-1.35378,-2.48686e-16,645.315,-240.196)">
          <path :class="{ 'active-control': controller?.buttons.y.pressed }"
            d="M354.907,196.001C345.094,196.001 337.14,203.277 337.14,212.252L354.907,212.252L354.907,196.001Z"
            style="stroke:currentColor;stroke-width:2.57px;stroke-linecap:round;stroke-miterlimit:1.5;" />
        </g>
      </g>
      <g transform="matrix(1.12514,0,0,1.16981,-24.6477,-37.4718)">
        ...
        <g clip-path="url(#_clip1)">
          <g id="left-joystick" transform="matrix(1.50628,0,0,1.50219,-76.2512,-107.713)">
            <ellipse :cx="154.401 + ((controller?.stick.left.horizontal || 0) * 4)"
              :cy="208.133 + ((controller?.stick.left.vertical || 0) * 4)" rx="15.341" ry="14.796"
              class="fill-transparent" :class="{ 'active-control': isLeftStickActive }"
      ...
      <g>
        <g id="select" transform="matrix(0.36945,-4.30683e-33,-4.30683e-33,0.384118,167.379,123.87)">
          <ellipse :class="{ 'active-control': controller?.back.pressed }" cx="156.319" cy="204.944" rx="29.774"
            ry="28.637" style="stroke:currentColor;stroke-width:8.29px;stroke-linecap:round;stroke-miterlimit:1.5;" />
        </g>
        <g id="start" transform="matrix(0.36945,-4.30683e-33,-4.30683e-33,0.384118,224.659,123.87)">
          <ellipse :class="{ 'active-control': controller?.start.pressed }" cx="156.319" cy="204.944" rx="29.774"
            ry="28.637" style="stroke:currentColor;stroke-width:8.29px;stroke-linecap:round;stroke-miterlimit:1.5;" />
        </g>
      </g>
      <g transform="matrix(1.12514,0,0,1.16981,129.019,24.1131)">
        ...
        <g clip-path="url(#_clip2)">
          <g id="right-joystick" transform="matrix(1.50628,0,0,1.50219,-76.2512,-107.713)">
            <ellipse :cx="154.401 + ((controller?.stick.right.horizontal || 0) * 4)"
              :cy="208.133 + ((controller?.stick.right.vertical || 0) * 4)" rx="15.341" ry="14.796"
      ...
      <g>
        <g>
          <g id="rb" transform="matrix(0.61812,0.0171064,-0.0276642,0.999617,259.736,-3.21975)">
            <path :class="{ 'active-control': controller?.bumper.right.pressed }"
          ...
          <g id="rt" transform="matrix(0.716144,0.0198192,-0.0244414,0.883165,143.069,9.76017)">
            <path :class="{ 'active-control': controller?.triggers.right.pressed }"
        ...
        <g transform="matrix(-1,0,0,1,497.232,0)">
          <g id="lb" transform="matrix(0.61812,0.0171064,-0.0276642,0.999617,259.736,-3.21975)">
            <path :class="{ 'active-control': controller?.bumper.left.pressed }"
              d="M198.988,132.494C198.988,128.797 194.134,125.795 188.155,125.795L141.898,125.795C135.92,125.795 131.066,128.797 131.066,132.494C131.066,136.191 135.92,139.192 141.898,139.192L188.155,139.192C194.134,139.192 198.988,136.191 198.988,132.494Z"
              style="stroke:currentColor;stroke-width:4.01px;stroke-linecap:round;stroke-miterlimit:1.5;" />
          </g>
          <g id="lt" transform="matrix(0.716144,0.0198192,-0.0244414,0.883165,143.069,9.76017)">
            <path :class="{ 'active-control': controller?.triggers.left.pressed }"
              d="M321.473,92.294C321.473,84.798 313.967,78.712 304.723,78.712C295.478,78.712 287.973,84.798 287.973,92.294L287.973,114.931L321.473,114.931L321.473,92.294Z"
              style="stroke:currentColor;stroke-width:4.14px;stroke-linecap:round;stroke-miterlimit:1.5;" />
          </g>
        </g>
